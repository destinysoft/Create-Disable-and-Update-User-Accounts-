...
<img width="758" height="674" alt="Open server maanger" src="open server maanger.png.png" />
...
<img width="1009" height="724" alt="click tools" src="navigate the ADUC via tool menu.png" />
...
<img width="1012" height="725" alt="ON domain right click to Organization Unit" src="Right-click the Domain to Create a New OU.png.png" />
...
<img width="438" height="373" alt="ORG UNIT" src="name the organisational unit.png" />
...
<img width="854" height="640" alt="SELECT TO CREATE OFFICE USER" src="Right-click Office Users → New → User.png.png" />
...
| First name | Bob |
| Last name | Thornton |
| Full name | Bob Thornton |
| User logon name | Bton |
| Domain | @mylab.local |

Click **Next**.

<img width="438" height="387" alt="CREATE NEW OFFICE USER" src="fill in the user details.png" />
...
<img width="437" height="377" alt="CREATING PASSWORD" src="Set the Initial Password.png.png" />
...
- Full name: Bob Thornton
- User logon name: Bton@mylab.local

Click **Finish**.

<img width="437" height="380" alt="CLICK FINISH" src="confirm and finish.png" />



<img width="847" height="627" alt="" src="bob now appears in the office user OU.png" />

The user **Bob Thornton** now appears in the Office Users OU.
...
Right-click **Bob Thornton** in the Office Users OU and select **Properties**.

<img width="847" height="627" alt="" src="Open User Properties.pn.png" />
...
|---|---|
| Office | Mylab |
| Telephone number | +447418073359 |
| Email | destinyosamudiamen96@gmail.com |

Click **Apply**.

<img width="408" height="555" alt="" src="Populate the General Tab.png.png" />
...
<img width="411" height="554" alt="FILL IN ORGANIZATION TAB" src="Populate the Organization Tab.png.png" />
...
<img width="408" height="546" alt="FILL IN TELEPHONE " src="Populate the Telephones Tab.png.png" />
...
<img width="849" height="631" alt="cREATING NEW GROUP" src="create the sales security group.png" />
...
<img width="436" height="381" alt="" src="configure the group.png.png" />
...
Right-click **Bob Thornton** and select **Properties** to navigate to the group membership settings.

<img width="852" height="629" alt="LOOKING FOR MEMBER OF" src="Open User Properties to Access Member Of Tab.png.png" />
...
<img width="405" height="551" alt="CLICK ON ADD" src="navigate the member of and click add.png" />
...
<img width="456" height="253" alt="" src="Search for and Add the Sales Group.png.png" />
...
<img width="411" height="543" alt="" src="configure griup membership.png" />
...
Right-click **Bob Thornton** in the Office Users OU and select **Disable Account** from the context menu.

<img width="850" height="629" alt="" src="Right-click the Account and Select Disable Account.png.png" />
...
Right-click **Bob Thornton** and select **Enable Account**.

<img width="848" height="622" alt="" src="Re-enable the Account.png.png" />
...
> *"Object Bob Thornton has been enabled."*
...
<img width="848" height="627" alt="" src="onfirm the Re-enable Action.png.png" />
...
──────────────────────────────────────────────────────────────────
TICKET #0011 | NEW STARTER PROVISIONING + TEMPORARY SUSPENSION
Technician: Destiny Osamudiamen | Date: May 2026 | Priority: STANDARD
──────────────────────────────────────────────────────────────────
...
ACTIONS TAKEN - PROVISIONING:
  ...
  3. Created new user: Bob Thornton (Bton@mylab.local) inside
     the Office Users OU.
...
ACTIONS TAKEN - SUSPENSION:
  ...
  10. Right-clicked Bob Thornton → Disable Account.
  11. Confirmed AD notification: Object Bob Thornton has been disabled.
...
ACTIONS TAKEN — REINSTATEMENT:
  ...
  14. Right-clicked Bob Thornton → Enable Account.
  15. Confirmed AD notification: Object Bob Thornton has been enabled.
...
| User Bob Thornton created inside Office Users OU | Pass |
