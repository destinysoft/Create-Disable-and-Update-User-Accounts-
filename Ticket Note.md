...
| Assigned To | Destiny Osamudiamen — IT Support |
| Affected User | Bob Thornton |
| Logon Name | Bton@mylab.local |
| Department | Sales |
...
3. Created user account: Bob Thornton with logon name Bton@mylab.local inside the Office Users OU
...
1. Located Bob Thornton in ADUC
2. Right-clicked account and selected Enable Account
3. Received AD confirmation: Object Bob Thornton has been enabled
...
*Documented by Destiny Osamudiamen — IT Support Portfolio*
